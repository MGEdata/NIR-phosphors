...
dataset = pd.read_csv("WL_training set.csv")
...
def model(x, y, data_predict):
    param_grid = [{"alpha": [0.1, 0.15, 0.2, 0.05, 0.01, 0.001], "gamma": np.logspace(-2, 2, 10)}]
...
dataset1 = pd.read_csv("WL_To predict.csv")
